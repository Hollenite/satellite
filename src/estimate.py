...
class SolarConfig:
    ...
    Defaults are conservative and appropriate for Indian residential
    rooftop solar pre-assessment (PM Surya Ghar style).
    """
    # -- Roof parameters --
    ...
    limitations: List[str] = field(default_factory=lambda: [
        ...
        "No state/DISCOM net metering approval logic",
